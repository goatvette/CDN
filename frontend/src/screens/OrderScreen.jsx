...
const OrderScreen = () => {
  ...
  return isLoading ? (
    ...
    <>
      <h1 className='text-black'>Order {order._id}</h1>
      <Row>
        <Col md={8}>
                      ...
                      <Row>
                        ...
                        <Col>
                          <Link to={`/product/${item.product}`}>
                            {item.name} ({item.size}, {item.frame} Frame)
                          </Link>
                        </Col>
                        <Col md={4} className='text-black'>
                          {item.qty} x {item.price} AED ={' '}
            ...
            <ListGroup variant='flush'>
              ...
              <ListGroup.Item>
                <Row>
                  ...
                  <Col className='text-black'>{order.itemsPrice} AED</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
              ...
              <ListGroup.Item>
                <Row>
                  ...
                  <Col className='text-black'>{order.taxPrice} AED</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
                  <Col className='text-black'>Total</Col>
                  <Col className='text-black'>{order.totalPrice} AED</Col>
                </Row>
              </ListGroup.Item>
              {!order.isPaid && (
                <ListGroup.Item>
